...
from keras.layers import LSTM, Dense, Dropout, BatchNormalization, Input, Bidirectional, GRU, Attention, Concatenate
...
class LSTMModelTrainer:
    ...
    def build_model(self, model_config):
        ...
        inputs = Input(shape=(model_config['input_shape'][1], 1))
        x = inputs
        ...
        for layer in model_config['layers']:
            if layer['type'] == 'lstm':
                ...
                x = GRU(units=layer['units'], return_sequences=layer.get('return_sequences', False), kernel_regularizer=layer['kernel_regularizer'])(x)
...
if __name__ == "__main__":
    ...
    trainer.train_lstm(X_train_scaled, y_train, X_val_scaled, y_val, best_model_config, epochs=50)
