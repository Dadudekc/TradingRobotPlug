...
from Tabs.risk_management_resources.HistoricalDataManager import HistoricalDataManager
...
class RiskManagementTab(ttk.Frame):
    def __init__(self, parent, model_manager):
        ...
        self.model_manager = model_manager  # Use the passed model_manager
        self.create_widgets()
...
if __name__ == "__main__":
    ...
    # Pass model manager instance to ChartTab
    chart_tab = ChartTab(tab_control, model_manager)  
    tab_control.add(chart_tab, text="Chart")
