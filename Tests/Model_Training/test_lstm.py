...
from tensorflow.keras.layers import LSTM, Dense, Dropout, BatchNormalization, Input, Bidirectional, Attention
...
if __name__ == "__main__":
    ...
    data = pd.read_csv('C:/TheTradingRobotPlug/data/alpha_vantage/tsla_data.csv')
    ...
    X_train, y_train = LSTMModelTrainer.create_sequences(X_train, y_train, time_steps)
    X_val, y_val = LSTMModelTrainer.create_sequences(X_val, y_val, time_steps)
    X_test, y_test = LSTMModelTrainer.create_sequences(X_test, y_test, time_steps)
